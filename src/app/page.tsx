  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-20 bg-gradient-to-b from-transparent to-black/20">
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-serif text-4xl md:text-5xl text-foreground mb-4">Featured Work</h2>
          ...
          <div className="grid gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            {galleryImages.map((image, index) => (
              <div key={index} className="group relative overflow-hidden rounded-xl border border-white/10 bg-background/5 hover:border-white/20 transition-all duration-300 transform hover:scale-105">
                <Image
                  src={image}
                  alt={`Tattoo ${index + 1}`}
                  width={300}
          ...
          <div className="text-center mt-10">
            <Link
              href="/gallery"
              className="inline-block rounded-lg border border-white/20 px-6 py-3 text-sm hover:bg-background/5 text-foreground/90 transition-colors duration-300"
            >
              View Full Gallery →
            </Link>
          </div>
      ...
      <section className="py-20">
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-serif text-4xl md:text-5xl text-foreground mb-4">Meet Our Artists</h2>
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {artists.map((artist, index) => (
              <div key={index} className="group rounded-xl border border-white/10 p-6 hover:border-white/20 transition-all duration-300 bg-gradient-to-br from-background/5 to-transparent backdrop-blur-sm">
                ...
                <h3 className="text-foreground text-xl font-semibold mb-2">{artist.name}</h3>
                <p className="text-foreground/70 text-sm leading-relaxed">{artist.specialty}</p>
              </div>
            ))}
          </div>
          <div className="text-center mt-10">
      ...
      <section className="py-20 bg-gradient-to-b from-black/20 to-transparent">
        <Container>
          <div className="text-center mb-12">
            <h2 className="font-serif text-4xl md:text-5xl text-foreground mb-4">Why Choose Us</h2>
            <p className="text-foreground/70 text-lg max-w-2xl mx-auto">
              Experience the difference with our commitment to quality and artistry
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group rounded-xl border border-white/10 p-8 hover:border-white/20 transition-all duration-300 bg-gradient-to-br from-background/5 to-transparent backdrop-blur-sm transform hover:scale-105">
              <div className="w-12 h-12 rounded-full bg-background/10 flex items-center justify-center mb-6 group-hover:bg-background/20 transition-colors duration-300">
                <span className="text-2xl">🎨</span>
              </div>
              <h3 className="text-foreground text-xl font-semibold mb-4">Custom Work</h3>
            ...
            <div className="group rounded-xl border border-white/10 p-8 hover:border-white/20 transition-all duration-300 bg-gradient-to-br from-background/5 to-transparent backdrop-blur-sm transform hover:scale-105">
              ...
              <h3 className="text-foreground text-xl font-semibold mb-4">Clean & Safe</h3>
              <p className="text-foreground/70 leading-relaxed">
            ...
            <div className="group rounded-xl border border-white/10 p-8 hover:border-white/20 transition-all duration-300 bg-gradient-to-br from-background/5 to-transparent backdrop-blur-sm transform hover:scale-105">
              ...
              <h3 className="text-foreground text-xl font-semibold mb-4">Easy Booking</h3>
              <p className="text-foreground/70 leading-relaxed">
